"""
Django settings for hayalisleri project.
...
SECRET_KEY = 'django-insecure-#3zqk8_wka)&k7se1lp=ozb(mq$$&la%j(^$p2gbtb0paecv1x'
...
WSGI_APPLICATION = 'hayalisleri.wsgi.application'
